            ...
            <div class="row gx-lg-5 align-items-center mb-5">
                <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                    <h1 class="my-5 display-5 fw-bold ls-tight" style="color: hsl(218, 81%, 95%)">
                        Welcome back <br />
                        <span style="color: hsl(218, 81%, 75%)">we've missed you</span>
                    </h1>
                    <p class="mb-4 opacity-70" style="color: hsl(218, 81%, 85%)">
                        Sign in to access your dashboard, manage your services, and explore new features designed just for
                        you.
                    </p>
                </div>
                                ...
                                @if (Route::has('register'))
                                    <div class="text-center mb-3">
                                        <p class="mb-0">
                                            ...
                                            <a href="{{ route('register') }}" class="text-primary fw-bold">Register
                                                here</a>
                                        </p>
                                    </div>
                                @endif
