    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <p class="text-muted">add more faqs for posting</p>
                ...
                <div class="row">
                    <div class="col-md-6 offset-3">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('faqs.store') }}" method="POST" class="needs-validation"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @method('post')
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom01">Qeustion</label>
                                        <input type="text" name="question" class="form-control" id="validationCustom01" value="question" required>
                                        <div class="valid-feedback"> Looks good! </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom01">Answer</label>
                                        <input type="text" name="answer" class="form-control" id="validationCustom01" value="answer" required>
                                        <div class="valid-feedback"> Looks good! </div>
                                    </div>
