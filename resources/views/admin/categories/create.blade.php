...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="page-title">Service Categories Posts</h2>
                <p class="text-muted">add more Service Categories for posting</p>
                ...
                <div class="row">
                    <div class="col-md-6 offset-3">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="{{ route('service_categories.store') }}" method="POST" class="needs-validation"
