                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-b">
                                    <div class="col-6 text-center mb-3 border-right">
                                        ...
                                        <p class="text-muted mb-2">+5.5% <span
                                                class="fe fe-arrow-up fe-12 text-success"></span></p>
                                    </div>
                                    ...
                                    <div class="col-6 text-center border-right">
                                        ...
                                        <p class="text-muted mb-2">+1.5% <span
                                                class="fe fe-arrow-up fe-12 text-warning"></span></p>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-4">
                                        <div class="map-box"
                                            style="position: relative; width: 320px; min-height: 170px; margin:0 auto;">
                                ...
                                <table class="table table-hover table-borderless table-striped mt-n3 mb-n1">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Enim Limited<br /><span class="small text-muted">901-6206 Cras
                                                    Av.</span></td>
                                            <td>Apr 24, 2019</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Nunc Lectus Incorporated<br /><span class="small text-muted">Ap
                                                    #705-5389 Id St.</span></td>
                                            <td>May 23, 2020</td>
                        ...
                        <div class="card shadow eq-card timeline">
                            ...
                            <div class="card-body" data-simplebar
                                ...
                                <div class="pb-3 timeline-item item-primary">
                                    <div class="pl-5">
                                        <div class="mb-1 small"><strong>@Brown Asher</strong><span
                                                class="text-muted mx-2">Just create new layout Index, form,
                                ...
                                <div class="pb-3 timeline-item item-warning">
                                    <div class="pl-5">
                                        <div class="mb-3 small"><strong>@Fletcher Everett</strong><span
                                                class="text-muted mx-2">created new group
                                ...
                                <div class="pb-3 timeline-item item-success">
                                    <div class="pl-5">
                                        <div class="mb-2 small"><strong>@Kelley Sonya</strong><span
                                                class="text-muted mx-2">has commented on</span><strong>Advanced
                                                table</strong></div>
                                        <div class="card d-inline-flex mb-2">
                                            <div class="card-body bg-light small py-2 px-3"> Lorem ipsum dolor
